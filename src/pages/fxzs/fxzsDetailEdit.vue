    ...
    <div class="container">
      <div class="group">
        ...
        <ul class="selection-list">
          <router-link :to="{path:'/fxzs/fxzsDetailEdit/fxzsSelZs'}" tag="li">
          <li class="selection">
      ...
      <div class="group">
        ...
        <ul class="selection-list">
          <li class="selection">
            <div class="input-box">
              <input type="text" placeholder="请输入证书编号" value="datas.licenseSn"/>
            </div>
          </li>
        </ul>
      </div>
...
//        }
    ...
    created(){
      this.datas = this.$route.query.fxzsDetail;
